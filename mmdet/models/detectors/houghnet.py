...
class HoughNet(SingleStageDetector):
    """Implementation of HoughNet: Integrating near and long-range
                        evidence for bottom-up object detection

    <https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123700409.pdf>.
    """
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(HoughNet, self).__init__(backbone, neck, bbox_head, train_cfg,
